...
module.exports = (grunt) => {
  ...
  grunt.initConfig({
    ...
    clean: {
      build: ['dist/*'],
      tmp: ['grafana-navigation-bar-options*'],
      release: ['grafana-navigation-bar-options*.zip']
    },
    ...
    copy: {
      ...
      dist_to_tmp: {
        cwd: './',
        expand: true,
        src: ['**/*', '!**/node_modules/**', '!**/grafana-navigation-bar-options*.zip'],
        dest: 'grafana-navigation-bar-options'
      },
    },
